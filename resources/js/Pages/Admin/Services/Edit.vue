...
const form = useForm({
    ...
    net_price: props.service.net_price || 0,
    commission: props.service.commission || 0,
    commission_type: props.service.commission_type || 'fixed',
    ...
    gallery: [], // Don't preload existing gallery for now, only new uploads
});
...
<template>
    <AdminLayout title="Edit Service">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Service: {{ service.title }}</h2>
        </template>
                    ...
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                             ...
                             <div class="col-span-2">
                                <label class="block text-sm font-medium text-gray-700">Gallery Images (Upload New)</label>
                                ...
                                <div v-if="service.gallery && service.gallery.length" class="mt-2 text-xs text-gray-500">
                                    Current gallery has {{ service.gallery.length }} images.
                                </div>
                            </div>
