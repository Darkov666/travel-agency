...
const form = useForm({
    ...
    commission: props.product.commission || 0,
    commission_type: props.product.commission_type || 'fixed',
...
<template>
    <AdminLayout title="Edit Product">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Product: {{ product.title }}</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex justify-end mt-6">
                            <Link :href="route('admin.products.index')" class="mr-4 px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Cancel</Link>
